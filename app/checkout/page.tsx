...
type Method = "cod" | "easypaisa" | "sadapay";
            ...
            <div className="pt-2">
              ...
              <div className="space-y-2">
                {([
                  ...
                  ["easypaisa", "Easypaisa", "You'll be guided to pay via Easypaisa"],
                  ["sadapay", "SadaPay (manual transfer)", "Transfer to our SadaPay, then we confirm"],
                ] as [Method, string, string][]).map(([val, title, sub]) => (
                  <label
                    key={val}
